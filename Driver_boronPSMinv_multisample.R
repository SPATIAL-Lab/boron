#
# Driver for multisample data inversion using forward Boron PSM 
# 
# Dustin T. Harper
# 11 October 2022
...
# (e.g., Hollis et al., 2019 recommend 7% per 0.1 pH unit, plus 1sd unc)
pHpccorr = 7
pHpccorrsd = 1.8
...
prox.in = read.xlsx(input.df, sheet = "data2")
...
jout = jags.parallel(model.file = "boronPSMinv_multisample.R", parameters.to.save = parms,
