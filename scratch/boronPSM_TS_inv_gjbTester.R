...
############################################################################################    
  ...
  dic.m = 0.0022
  dic.p = 1/0.0002^2
  dic[1] ~ dnorm(dic.m, dic.p)I(0.00015, 0.00025)
  dic.pc = 1e5
  dic.mc = 1
  ...
  # Atmospheric pCO2 (atm)
  pco2f.sig[i] ~ dnorm(pco2.mc, pco2.pc)I(0.5,1.5)
  pco2f[i] = pco2f[i-1] #* pco2f.sig[i]
  pco2[i] = pco2f[i] * dic[i]
